...
class LegislationController extends Controller
{
    ...
    {
        $reports = Legislation::paginate(10);
        return view('admin.legislation.index', ['reports' => $reports]);
    }
    ...
    {
        return view('admin.legislation.add');
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'year' => 'required',
            'legislation_num' => 'required',
            'path' => 'required',
        ],[
            'name.required' => 'الإسم مطلوب',
            'year.required' => 'السنة مطلوبة',
            'legislation_num.required' => 'رقم التقرير مطلوب',
        ...
        Legislation::create([
            'name' => $request->name,
            'year' => $request->year,
            'legislation_num' => $request->legislation_num,
            'date' => $request->date,
            'path' => $file,
            'state' => $request->state,
        ]);
        ...
        return redirect()->route('admin.legislation.index');
    }
    ...
    {
        $report = Legislation::findOrFail($id);
        return view('admin.legislation.edit', ['report' => $report]);
    }
