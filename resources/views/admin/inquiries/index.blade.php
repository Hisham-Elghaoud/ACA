			...
			<table id="branches" class="compact row-border cell-border" width="100%">
				...
				<tbody>
					...
					<tr>
					  ...
					  <td>{{$inquirie->summary}}</td>
					  <td>
                        <a data-bs-toggle="modal" data-bs-target="#inquirieModal{{$inquirie->id}}" title="حذف" style="cursor: pointer;"><i class="fa fa-times fa-2x text-danger"></i></a>
					</td>
					</tr>
					<div class="modal fade" id="inquirieModal{{$inquirie->id}}" tabindex="-1" aria-labelledby="inquirieModalLabel{{$inquirie->id}}" aria-hidden="true">
						<div class="modal-dialog" style="width:394px;max-width: 100%">
						<div class="modal-content">
							<div class="modal-header">
							<h5 class="modal-title">حذف بلاغ</h5>
							...
							<div class="modal-footer">
								...
								<a href="{{route('admin.inquiries.delete', $inquirie->id)}}" class="btn btn-danger mx-1 font-1 save-image">{{trans('auth.delete')}}</a>
							</div>
						</div>
						</div>
					</div>
