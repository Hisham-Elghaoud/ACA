...
<body style="background: #f7f7f7" class="dash">
    ...
    <div class="col-12 d-flex">
        ...
        {{-- <div class="col-12 px-0 py-5 text-center justify-content-center align-items-center ">
            ...
            <img src="{{asset('storage/public/uploads/users/')}}/{{auth()->user()->getUserAvatar()}}" style="width: 55px;height: 55px;color: #fff;border-radius: 50%" class="d-inline-block">
                </a>
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-0">
                    ...
                    <a href="{{route('admin.branches.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-qrcode font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                               الفروع
                            </div> 
                    ...
                    <a href="{{route('admin.news.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('admin.vedionews.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('admin.extrasites.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-hands-helping font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                               مواقع أخرى
                            </div> 
                    ...
                    <a href="{{route('admin.yearlyreports.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-clipboard font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                               التقارير السنوية
                            </div> 
                    ...
                    <a href="{{route('admin.descisions.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-quote-left font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                القرارات
                            </div> 
                    ...
                    <a href="{{route('admin.legislation.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-bars font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                التشريعات
                            </div> 
                    ...
                    <a href="{{route('admin.study.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('admin.inquiries.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('admin.complaints.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-microphone font-3"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                الشكاوى
                            </div> 
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center  dropdown"  style="width: 60px;height: 60px;" >
                        <div style="width: 60px;height: 60px;" data-bs-toggle="dropdown" aria-expanded="false" class="d-flex justify-content-center align-items-center cursor-pointer">
                            <img src="{{asset('storage/public/uploads/users/')}}/{{auth()->user()->getUserAvatar()}}" style="padding: 10px;border-radius: 50%;width: 60px;height: 60px;">
                        </div>
